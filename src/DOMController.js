...
function createToDoList() {
  ...
  ToDoList.forEach((list) => {
    ...
    createRadio.checked = list.done === true;
...
// Change it to normal function not IIFE
const addNewTask = (() => {
...
function renderToDos(index) {
  ...
  const heading = createProjectHeading(projectsList[index].name);
  const content = createToDoList();
